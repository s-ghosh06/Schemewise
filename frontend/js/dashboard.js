// ============================================================
// SCHEMEWISE — Admin Dashboard JavaScript
// ============================================================
        ...
        plugins: {
          legend: {
            ...
            labels: {
              ...
              color: getComputedStyle(document.documentElement).getPropertyValue('--text-primary').trim() || '#0a1628'
            }
          }
        }
      }
...
async function loadBarChart() {
  try {
    ...
    const d = data.data;
    const textColor = getComputedStyle(document.documentElement).getPropertyValue('--text-primary').trim() || '#0a1628';
    ...
    barChartInstance = new Chart(document.getElementById('barChart'), {
      ...
      options: {
        ...
        plugins: {
          legend: {
            labels: { font: { size: 11, family: 'IBM Plex Sans' }, color: textColor, boxWidth: 12 }
          }
        }
      }
    });
